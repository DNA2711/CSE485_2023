...
CREATE TABLE
    tacgia (
        ma_tgia INT UNSIGNED AUTO_INCREMENT NOT NULL PRIMARY KEY,
...
CREATE TABLE
    theloai (
        ma_tloai INT UNSIGNED AUTO_INCREMENT NOT NULL PRIMARY KEY,
        ten_tloai VARCHAR(50) NOT NULL
    );

CREATE TABLE
    baiviet (
        ma_bviet INT UNSIGNED AUTO_INCREMENT NOT NULL PRIMARY KEY,
...
INSERT INTO
    theloai VALUE (1, "Nhạc trẻ");

INSERT INTO
    theloai VALUE (2, "Nhạc trữ tình");

INSERT INTO
    theloai VALUE (3, "Nhạc cách mạng");

INSERT INTO
    theloai VALUE (4, "Nhạc thiếu nhi");

INSERT INTO
    theloai VALUE (5, "Nhạc quê hương");

INSERT INTO
    theloai VALUE (6, "POP");

INSERT INTO
    theloai VALUE (7, "Rock");
