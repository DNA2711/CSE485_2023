                ...
                <div class="bg-white mt-auto mb-auto h-100 w-50 rounded p-5">
                    ...
                    <div class="card-body pt-4 px-5">
                        <form action="process_login.php" method="post">
                            ...
                            <div class="form-group d-flex justify-content-center py-4">
                                <input type="submit" value="Login" class="btn w-50 text-white text-md-center"
                                    style="background: linear-gradient(-135deg,#c850c0,#4158d0)">
                            </div>
                        </form>
                        <div class="d-flex justify-content-center mb-4" style="font-size: 50px">
                            <div class="d-flex justify-content-evenly w-75 align-items-center" <span><i
                                    class="fa-brands fa-facebook" style="color: #005eff;"></i></span>
                    ...
                    <div class="card-footer">
                        <div class="d-flex justify-content-center ">
                            Don't have an account? <a href="#" class="text-warning text-decoration-none mx-1"
                                style="color: #005eff !important;"> Sign Up</a>
                        </div>
                        <div class="d-flex justify-content-center">
                            <a href="#" class="text-warning text-decoration-none"
                                style="color: #005eff !important;">Forgot your password?</a>
                        </div>
                    </div>
                </div>
        </main>
